...
NSInteger const kLeadsTab = 1;
NSInteger const kAgreementsTab = 2;
NSInteger const kToolsTab = 3;
NSInteger const kReportsTab = 4;
NSString * const kAppType = @"sales";
BOOL kNeedsEncryption = YES;
NSString * const kIPadStoryBoard = @"MainStoryboard_iPad";
NSString * const kPublicEncryptionKey = @"com.mysalesrabbit.publickey";
NSString * const kEncryptionKeyApplicationTag = @"com.mysalesrabbit.privatekey";
NSString * const kFlurryAppKey = @"ZYYKN46GBBJRB22CCF7V";
BOOL const kReportProducts = YES;


// Info Message
NSString * const kInfoTitle = @"Welcome to Sales Rabbit";
NSString * const kInfoMessage = @"Sales Rabbit is the ultimate satellite sales tool. Lead management, paperless agreements, live leaderboards, closing tools and much more.";

//Core Data
NSString * const kCoreDataPath = @"SalesRabbitDishSales.sqlite";
...
+ (void)initValues {
    ...
    if (!valuesInitialized) {
        ...
        kReminderTimeDictionary = @{kRemindNone: @-1,
                                    kRemind0Min: @0,
                                    kRemind5Min: [NSNumber numberWithInt:(int)kSecondsIn5Minutes],
                                    kRemind15Min: [NSNumber numberWithInt:(int)kSecondsIn15Minutes],
                                    kRemind30Min: [NSNumber numberWithInt:(int)kSecondsIn30Minutes],
                                    kRemind1Hr: [NSNumber numberWithInt:(int)kSecondsIn1Hour]};
