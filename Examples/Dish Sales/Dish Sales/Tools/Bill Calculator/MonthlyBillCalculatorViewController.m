...
#import "MonthlyBillCalculatorViewController.h"
...
@interface MonthlyBillCalculatorViewController () <AVSelectionListDelegate, UIPopoverControllerDelegate>
...
@implementation MonthlyBillCalculatorViewController
...
- (void)viewDidLoad
{
    ...
    self.choicesViewOne = [[[NSBundle mainBundle] loadNibNamed:@"BillCalcChoicesViewOne" owner:self options:nil] lastObject];
    self.choicesViewTwo = [[[NSBundle mainBundle] loadNibNamed:@"BillCalcChoicesViewTwo" owner:self options:nil] lastObject];
    self.choicesViewThree = [[[NSBundle mainBundle] loadNibNamed:@"BillCalcChoicesViewThree" owner:self options:nil] lastObject];
...
- (void)resetViewsFromProviderSelection:(NSString *)selection {
    ...
    if ([selection isEqualToString:kComcast] || [selection isEqualToString:kCharter] || [selection isEqualToString:kCableOne]) {
...
- (IBAction)tvOneSegmentChanged:(id)sender {
    ...
    self.numberTVs = [NSNumber numberWithInt:self.tvSegmentedControlOne.selectedSegmentIndex];
...
- (IBAction)hdDVROneSegmentChanged:(id)sender {
    ...
    self.hardwarePriceA = [PriceCalculator priceForHardwareOption:kHDDVR
                                                         quantity:[NSNumber numberWithInt:self.hdDVRSegmentedControlOne.selectedSegmentIndex]
...
- (IBAction)hdOnlyOneSegmentChanged:(id)sender {
    ...
    self.hardwarePriceB = [PriceCalculator priceForHardwareOption:kHDOnlyBoxes
                                                         quantity:[NSNumber numberWithInt:self.hdOnlySegmentedControlOne.selectedSegmentIndex]
                                                         provider:self.currentProvider];
...
- (void)movieChannelOneChanged {
    ...
    NSDictionary *moviePricesDict = [PriceCalculator pricesForMovieChannels:movieChannelsSelected provider:self.currentProvider];
...
- (IBAction)tvTwoSegmentChanged:(id)sender {
    ...
    self.numberTVs = [NSNumber numberWithInt:self.tvSegmentedControlTwo.selectedSegmentIndex];
    if (!self.receiverConfigButton.hidden && [self.betterProviderList.selectedItem isEqualToString:kDishNetwork]) {
        [self resetReceiverConfig];
    }
    if (self.benefitLabelB.alpha != 0) {
...
- (IBAction)multiTVDVRSegmentChanged:(id)sender {
    ...
    self.hardwarePriceA = [PriceCalculator priceForHardwareOption:kMultiTVDVR
                                                         quantity:[NSNumber numberWithInt:self.multiTVDVRSegmentedControl.selectedSegmentIndex]
                                                         provider:self.currentProvider];
...
- (IBAction)hdDVRTwoSegmentChanged:(id)sender {
    ...
    self.hardwarePriceB = [PriceCalculator priceForHardwareOption:kHDDVR
                                                         quantity:[NSNumber numberWithInt:self.hdDVRSegmentedControlTwo.selectedSegmentIndex]
                                                         provider:self.currentProvider];
...
- (IBAction)hdOnlyTwoSegmentChanged:(id)sender {
    ...
    self.hardwarePriceC = [PriceCalculator priceForHardwareOption:kHDOnlyBoxes
                                                         quantity:[NSNumber numberWithInt:self.hdOnlySegmentedControlTwo.selectedSegmentIndex]
                                                         provider:self.currentProvider];
...
- (IBAction)tvThreeSegmentChanged:(id)sender {
    ...
    self.numberTVs = [NSNumber numberWithInt:self.tvSegmentedControlThree.selectedSegmentIndex];
    
    self.hardwarePriceA = [PriceCalculator priceForHardwareOption:kTVs
                                                         quantity:[NSNumber numberWithInt:self.tvSegmentedControlThree.selectedSegmentIndex + 1]
                                                         provider:self.currentProvider];
...
- (IBAction)dvrThreeSegmentChanged:(id)sender {
    ...
    self.hardwarePriceB = [PriceCalculator priceForHardwareOption:kDVRCharge
                                                         quantity:[NSNumber numberWithInt:self.dvrSegmentedControlThree.selectedSegmentIndex]
                                                         provider:self.currentProvider];
...
- (IBAction)hdThreeSegmentChanged:(id)sender {
    ...
    self.hdPrice = [PriceCalculator priceForHardwareOption:kHDOption
...
- (void)checkListSelectionChanged:(AVSelectionListController *)sender selection:(NSString *)selection{
    ...
    //Results for choosing a current package
        ...
        self.packageBasePrice = [PriceCalculator priceForPackage:self.basePackageList.selectedItem provider:self.currentProvider];
...
- (void)updateBenefits {
    ...
    if ([self.betterProviderList.selectedItem isEqualToString:kDirecTv]) {
        ...
        self.benefitLabelB.text = [NSString stringWithFormat:@"✔ %d Digital TVs", [self.numberTVs intValue] + 1];
        self.benefitLabelC.text = @"✔ Free HD for life";
...
- (void)calculateNewProviderPrice{
    ...
    self.promoPrice = [PriceCalculator priceForPackage:self.sellingPackageList.selectedItem
                                              provider:self.betterProviderList.selectedItem
                                         configuration:self.receiverConfigList.selectedItem
                                               isPromo:YES
                                               numberTVs:self.numberTVs];
    self.regularPrice = [PriceCalculator priceForPackage:self.sellingPackageList.selectedItem
                                              provider:self.betterProviderList.selectedItem
                                         configuration:self.receiverConfigList.selectedItem
                                               isPromo:NO
                                               numberTVs:self.numberTVs];
    ...
    int moviesTotal = [[PriceCalculator totalPriceForMovieChannels:movieChoices provider:self.betterProviderList.selectedItem] intValue];
    ...
    if (self.warrantySwitch.on) {
        int warranty = [[PriceCalculator priceForWarrantyWithProvider:self.betterProviderList.selectedItem] intValue];
